<?php
/**
* Plugin Name: MasterBip Comunas de Chile
* Plugin URI: https://www.masterbip.cl
* Description: Plugin para agregar COMUNAS de CHILENOS en Woocommerce.
* Version: 1.0
...
* License: GPLv3
*
* MasterBip Comunas de Chile free software: you can redistribute it and/or modify
* it under the terms of the GNU General Public License as published by
* the Free Software Foundation, either version 3 of the License, or
* any later version.
*
* MasterBip Woocommerce Comunas de Chile is distributed in the hope that it will be useful,
...
function mb_woo_comunas_de_chile_field( $fields ) {
...
function mb_woo_comunas_de_chile_label($address_fields){
    $address_fields['city']['label']='Comuna';
    return $address_fields;
}

add_filter( 'woocommerce_checkout_fields', 'mb_woo_comunas_de_chile_field' );
add_filter('woocommerce_default_address_fields','mb_woo_comunas_de_chile_label');